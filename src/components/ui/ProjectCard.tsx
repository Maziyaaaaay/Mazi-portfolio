    ...
    >
      ...
      {hasVideo && (
        <span className="absolute inset-0 flex items-center justify-center bg-void/30 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          <span className="flex h-16 w-16 items-center justify-center rounded-full border border-gold bg-void/60 text-gold">
    ...
    <div>
      {hasVideo ? (
        <button
          ...
          onClick={() => onPlay?.(project.video!, project.title)}
